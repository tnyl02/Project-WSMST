...
const Home = () => {
  ...
  const features = [
    { icon: <DatabaseIcon />, title: "Rich Movie Data", description: "Access 30+ curated titles with synopses, ratings, and genres." },
    { icon: <KeyIcon />, title: "Instant API Keys", description: "Generate, reveal, or revoke your keys with a single click." },
    { icon: <ChartIcon />, title: "Real-time Analytics", description: "Monitor your API usage and quota limits via live dashboard." },
